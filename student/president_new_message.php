...
<?php
$req2 = mysql_query("SELECT students_name FROM students s,club_members m where m.club_id='". $_SESSION['cl_id'] ."' and s.studens_number=m.student_id");
//$id=0;
while ($dn2 = mysql_fetch_array($req2)){
	$i=$dn2['id'];
	echo '<option value=' . $i . '>' . $dn2['id']," ",$dn2['name'] . '</option>';
