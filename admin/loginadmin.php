...
if(isset($_SESSION['user'])!="")
{
	...
	?>
        <script>alert('You must be logged in to contact us!!');</script>
        <?php
}
...
<head>
	...
	<title>Club Membership System ! Login</title>
...
<body>
	...
	<div id="loading">
		...
		<div id="content" class="c-login clearfix">
			...
			<div class="header">
					<a href="loginadmin.php"><img src="images/logo.png"></a>
			</div> <!-- /header -->
			...
			<div class="widget-content">
				<input id="admin_username" type="text" name="admin_username" placeholder="Email / username">
				<input id="admin_password" type="password" name="admin_password" placeholder="Password">
				<a href="" name="submit" class="btn btn-blue pull-right" id="submit" type="submit">Login</a>
			</div>
			</form>
		...
		<footer class="footer">
		    Login As A club <a href="http://www.pixeden.com/">President</a></br>
			2016 © Gediz Club Membership System <a href="http://www.pixeden.com/">CMS</a>
		</footer>
