...
<?php include('top.php');?>
		...
		<div id="content" class="clearfix">
			...
			<div class="wrp clearfix">
                <div class="quick-nav">
					<ul>
						<li  class="active" ><a href="school_admins.php"><i class="fa fa-list"></i> View Admins</a></li>
				...
				<div class="fluid">
					<div class="widget grid6">
						<div class="widget-header">
							<div class="widget-title">
								<i class="fa fa-comments"></i> Administrators
							</div>
					...
					while($events= $rs->fetch_assoc()){
					  $admin_id =  $events['admin_id'];
					  $admin_name = $events['admin_name'];
					  $admin_username =  $events['admin_username'];
					 $admin_password = $events["admin_password"];
					...
					?>
						<div class="comment">
                            ...
                            <div class="comment-info">
                                	User Name: <span><?php echo $admin_username;?></span> Date created: <span><?php echo $time_updated;?></span>
