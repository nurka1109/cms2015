...
<?php include('top.php');?>
		...
		<div id="content" class="clearfix">
			...
			<div class="breadcrumbs">
				<i class="fa fa-home"></i> Home <i class="fa fa-caret-right"></i> Dashboard <i class="fa fa-caret-right"></i> Events
			</div>
			...
			<div class="wrp clearfix">
				  ...
				  <div class="quick-nav">
					<ul>
						...
						<li  ><a href="clubs_members.php" ><i class="fa fa-group"></i> View Members</a></li>
						<li class="active"><a href="clubs_events.php" ><i class="fa fa-globe"></i> View Events</a></li>
						<li >
				...
				<div class="fluid">
					<div class="widget grid7">
					 ...
					 $thumbnails = $events["thumbnails"];
                        ...
                        echo"{$events['news_title']}"; 
                        echo"<br>"; 
                        echo"<div class=\"comment-info\">"; 
                        echo"  Start Date: <span> {$events['start_date']}</span> End Date: <span> {$events['end_date']}</span>  Event Posted Date: <span> {$events['time_updated']}</span>";
						echo" </div>";	
                        echo"<div class=\"comment-controls\">"; 
						echo"<p>{$events['news_details']}</p>";	
						echo " <a href=\"event_list.php?view={$events['news_id']}\"><button class=\"btn btn-mini btn-green\">Red More ";
					    echo"</button></a>";
                        echo"</div>"; 
                        echo"</div>";
                        echo"</div> "; 
					...
					<div class="widget grid5">
						<div class="widget-header">
						   ...
						   <?php  if (isset($_GET['view'])) {
							$view = $_GET['view'];
							$query = "SELECT * FROM latest_news l WHERE `l`.`news_id` = {$view}";
							$rs=$db->query($query);
							$rs->data_seek(0);
                            ...
                            <div class="comment-controls">
								<p><?php echo $latest_ns['news_details']; ?></p>
								<?php echo "<a href=\"add_events.php?update=".$latest_ns['news_id']."\"> <button type=\"submit\" name=\"creat_club\"  class=\"btn btn-mini btn-green\">Add</button></a>";?> 					     
								<?php echo "<a href=\"edit_events.php?update=".$latest_ns['news_id']."\"> <button type=\"submit\" name=\"delete\"  class=\"btn  btn-mini btn-blue\">Edit</button></a>";?>								
