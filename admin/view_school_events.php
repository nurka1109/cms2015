			...
			<div class="wrp clearfix">
				...
				<div class="quick-nav">
					<ul>
						...
						<li  class="active" ><a href="view_school_events.php"><i class="fa fa-globe"></i> Events and News</a></li>
					</ul>
				</div>
				...
				<div class="fluid">
					<div class="widget grid7">
					 ...
					 <?php
					 $query = "SELECT * FROM gallery_photos gp,latest_news ln WHERE ln.photo_id = gp.id"; 
					 $rs=$db->query($query);
					 $rs->data_seek(0);
					 ...
					 $thumbnails = $events["thumbnails"];
						...
						echo " <a href=\"view_school_events.php?view={$events['news_id']}\"><button class=\"btn btn-mini btn-green\">Red More ";
					    echo"</button></a>";
                        echo"</div>"; 
                        echo"</div>";
                        echo"</div> "; 
					...
					<div class="widget grid5">
						<div class="widget-header">
						   ...
						   <?php  if (isset($_GET['view'])) {
							$view = $_GET['view'];
							$query = "SELECT * FROM gallery_photos gp,latest_news ln WHERE ln.photo_id = gp.id and news_id = {$view}";
							$rs=$db->query($query);
							$rs->data_seek(0);
