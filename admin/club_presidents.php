...
<?php include('top.php');?>
		...
		<div id="content" class="clearfix">
			...
			<div class="breadcrumbs">
				<i class="fa fa-home"></i> Home <i class="fa fa-caret-right"></i> Club Presidents
			</div>
			...
			<div class="wrp clearfix">
					...
					<ul>
						...
						<li class="active"><a href="club_presidents.php"><i class="fa fa-group"></i> View Club Presidents</a></li>
						<li ><a href="board_members.php"><i class="fa fa-group"></i> Club Board Members</a></li>
						<li class="active" ><a href="events_news.php"><i class="fa fa-globe"></i> Events and News</a></li>
					</ul>
				</div>
