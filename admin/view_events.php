...
<?php include('top.php');?>
		...
		<div id="content" class="clearfix">
			...
			<div class="wrp clearfix">
				...
				<div class="quick-nav">
					<ul>
						<li class="active"><a href="view_events.php" ><i class="fa fa-globe"></i> Recent Events and News</a></li>
				...
				<div class="fluid">
					<div class="widget grid7">
					 ...
					 $thumbnails = $events["thumbnails"];
						...
						echo " <a href=\"view_events.php?view={$events['news_id']}\"><button class=\"btn btn-mini btn-green\">Red More ";
					    echo"</button></a>";
                        echo"</div>"; 
                        echo"</div>";
                        echo"</div> "; 
